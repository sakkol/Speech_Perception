...
for i=1:2
    ...
    if strcmp(Sbj_Metadata.sbj_ID,'NS163') && strcmp(Sbj_Metadata.BlockLists{i},'SyllablePerception_EStim')
        info.events = info.events(~ismember(1:64,[1,11,14,16,21,22,25,31,32,33,37,41,43,51,54,58,61,62,63,64]),:); % remove the bad trials: trials when the e-stim was not ideal
    end
