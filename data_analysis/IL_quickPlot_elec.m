...
%             legend([s1.mainLine,s2.mainLine,s3.mainLine,s4.mainLine],{'Iso-Sentence','Iso-Scrambled','Achr-Sentence','Achr-Scrambled'})
    ...
    ax = axes;
    ax.Visible = 'off';
    text(gca,.5,1.07,[curr_label ' in ' info.channelinfo.Desikan_Killiany{strcmp(info.channelinfo.Label,elec)} '; ' xxx.Stim_type{1} ' Isochronous Listening Task; block: ' curr_block],...
...
%     sgtitle([curr_label ' in ' info.channelinfo.Desikan_Killiany{el} '; Isochronous Listening Task; block: ' curr_block])
    ...
    print(fullfile(save_folder,[curr_label , '_' curr_block '_Qplot_elec.jpg']),'-djpeg','-r300')
    close all
