function SP_separate_event_fourier(Sbj_Metadata,freq_bands)
...
fprintf('Saving ''fouri_of_words'' to:\n-->%s\n',fullfile(Sbj_Metadata.results,strjoin(control_blocks,'_'), [strjoin(control_blocks,'_') '_ctrl_word_fouri.mat']))
save(fullfile(Sbj_Metadata.results,strjoin(control_blocks,'_'), [strjoin(control_blocks,'_') '_ctrl_word_fouri.mat']),'fouri_of_words','-v7.3');
