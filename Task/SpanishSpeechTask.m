...
adaptation_intro_msg = ['Escuchar�s oraciones simples,\ncompuestas de 5 palabras\n\n'...
    'Cuando est� listo,\npresione la barra espaciadora\npara comenzar cada oraci�n'];
...
threshold_intro_msg = ['Ahora, escuchar� oraciones similares,\nincrustadas en el ruido\n\n'...
    'Por favor, trata de entender la frase que viene despu�s\n'...
    '''Presta atenci�n y recuerda esta oraci�n.''\n\n'...
    'Cuando est� listo,\npresione la barra espaciadora\npara comenzar cada oraci�n'];
...
real_deal_msg = ['Ahora, escuchar� oraciones similares.\n\n'...
   'Por favor, intente asistir y d�ganos cu�l es la oraci�n.\n\n'...
   'Para comenzar una nueva oraci�n, presione la barra espaciadora.'];
...
for trialN = 1:length(events_cell)
    ...
    DrawFormattedText(window, '�Cu�l fue la oraci�n?','center','center',par.textcolor);
    Screen('DrawText',window,num2str(this_trial_code),winRect(3)/20,winRect(4)*0.9,par.textcolor);
    Screen('Flip',window);
    WaitSecs(2);
